...
inline void Graph::setEdgeProperties(int nume, const std::vector<EdgeProperty> & properties) {
	edges.at(nume)->setProperties(properties);
} //tutaj narazie można tylko identyfikować krawędzie po pozycja w ich wektorze

inline void Graph::addEdgeProperty(int nume, const EdgeProperty & property) {
